            ...
            <div class="space-y-5">
                <div class="justify-between flex flex-wrap">
                    ...
                    <div class="inline-flex items-center justify-end">
                        ...
                        <input type="text" name="teacherid" placeholder="Search Anything by Name, Type, Grade" class="text-blue-800 mt-1 ml-1 w-full px-3 py-2 bg-white border-2 border-blue-800 rounded-md text-sm shadow-sm placeholder-blue-800/50 focus:outline-none focus:border-black focus:ring-1 focus:ring-black" />
                    </div>
                </div>
