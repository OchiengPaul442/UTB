<nav class="font-lato  md:px-2 px-2 py-2 z-50 sticky top-0 left-0 right-0 bg-blue-800 text-white drop-shadow-md shadow-black">
    <div class="flex justify-between">
        <!-- icon -->
        <a href="./index.php" class="bg-amber-400 p-2 rounded-md">
            <img src="../../img/utb_noback.png" height="80px" width="100px" alt="logo" />
        </a>
        ...
        <div class="space-x-2 flex justify-end items-center mt-4 md:mt-0 flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0">
            <!-- HOme -->
            <button onclick="goToHome()" class="inline-flex items-center text-blue-800 bg-amber-400
            ...
            <!-- Facilities -->
            <button onclick="goToFacilities()" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30">
                <!-- icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="none">
                    <g>
                        <rect fill="none" height="24" width="24" />
            ...
            <!-- Establishment Types -->
            <button onclick="goToEstablishmentType()" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30">
                <!-- icon -->
            ...
            <!-- Score Settings -->
            <button onclick="goToScoreSettings()" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30">
                <!-- icon -->
            ...
            <!-- Districts -->
            <button onclick="goToDistricts()" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30">
                <!-- icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" width="24px" height="24px" viewBox="0 0 24 24">
            ...
            <!-- Reports -->
            <button onclick="" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30">
                <!-- icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" width="24px" height="24px" viewBox="0 0 24 24">
            ...
            <!-- Users -->
            <button onclick="goToUsers()" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30">
                <!-- icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" width="24px" height="24px" viewBox="0 0 24 24">
  ...
  rounded-md font-semibold uppercase px-3 py-2 text-sm transition-colors duration-300">
            ...
            <!-- permissions -->
            <button onclick="gotoMypermissions()" class="inline-flex items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30 ">
                <!-- icon -->
            ...
            <!-- logout -->
            <button onclick="" class="inline-flex text-red-500 items-center hover:text-blue-800 hover:bg-amber-400 rounded-md font-semibold uppercase px-3 py-2 text-sm bg-transparent transition-colors duration-300 hover:border-blue-800/30 ">
                <!-- icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
