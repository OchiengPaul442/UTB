        ...
        <main class="w-full overflow-y-hidden">
            ...
            <div class="mx-8">
                <div class="flex flex-wrap justify-between pt-8">
                    ...
                    <div class="mt-4">
                        <a href="./create.php"> <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create a new District</button>
                        </a>
                    </div>
                </div>
            </div>
